...
#
# Generated by Vivado on Mon May 28 21:42:56 +08 2018
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ipshared/6490/sources_1/new/kd_tree.vhd" \
    "$ref_dir/../../../bd/design_1/ip/design_1_kd_tree_0_0/sim/design_1_kd_tree_0_0.vhd" \
    "$ref_dir/../../../bd/design_1/hdl/design_1.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work blk_mem_gen_v8_3_5 $vlogan_opts +v2k \
    "$ref_dir/../../../../kd_tree.srcs/sources_1/bd/design_1/ipshared/6273/simulation/blk_mem_gen_v8_3.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/neuromorphic/home_dirs/andres/workspace/RECOG_KEN/kd_tree/kd_tree.cache/compile_simlib/vcs"
  fi
